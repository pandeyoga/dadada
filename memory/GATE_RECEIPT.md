...
- **Waktu:** 2026-09-21 23:17:58
- **Mode:** `ci`  ·  **Durasi total:** 236s  ·  **Pekerja statik:** 2
...
| guard:notif_audience (INV-NOTIF-02, alamat notifikasi dari WEWENANG) | FAIL (5s) |
...
| verify_entity_scoping (F0-C, DB + STATIK anti-kebocoran PT) | PASS (2s) |
...
| audit_entity_isolation (E0.9/E0.10 — 0 kebocoran lintas-entitas) | PASS (14s) |
...
| POC F-2 Akses & UI/UX per peran (izin baca · pagar · KPI jujur · bukti-merah) | FAIL (5s) |
...
| POC FASE S (sampling: dua jenis paralel · ukur dari master · jadi→kirim · nol residu) | FAIL (1s) |
