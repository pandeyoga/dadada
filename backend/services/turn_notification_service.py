...
TURN_MAP: Dict[str, Dict[str, Dict[str, Any]]] = {
    "sales_orders": {
        ...
        "confirmed":        {"roles": ("warehouse", "warehouse_admin"), "permission": ("wms", "scan"), "title": "Siapkan barang (picking)", "link": "operations"},
    ...
    "sales_returns": {
        ...
        "inspected":        {"roles": ("finance", "sales_admin"), "permission": ("sales_return", "update"), "title": "Putuskan penyelesaian retur (refund/kredit/nego)", "link": "returns"},
