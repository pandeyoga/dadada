...
# KN-C03 — SATU daftar status "boleh keluar" untuk gate fisik (ingest) DAN Gate Monitor
# (simulate). Dulu daftar ini kehilangan committed/picked/packed sehingga roll yang justru
# siap berangkat dinyatakan MERAH oleh layar operator tetapi HIJAU oleh perangkat keras.
GREEN_OUT = {"reserved", "allocated", "committed", "picked", "packed",
