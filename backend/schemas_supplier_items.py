...
class SupplierItemCreate(BaseModel):
    ...
    entity_id: str = ""
    # FASE SL — pola label khusus barang ini (None = ikut pola supplier). Supplier campur-label.
    label_pattern: Optional[Dict[str, Any]] = None
...
class SupplierItemPatch(BaseModel):
    ...
    label_pattern: Optional[Dict[str, Any]] = None   # {} = hapus pola khusus → ikut supplier
