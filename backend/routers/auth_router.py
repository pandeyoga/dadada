...
async def session_payload(user: dict) -> dict:
    ...
    # Indikator data uji: akun/transaksi demo hanya ada bila SEED_DEMO_USERS=true di luar
    # produksi. Dikirim ke klien agar layar bisa menandai "DATA DEMO" secara global.
    import seed as _seed
    u["demo_data"] = bool(_seed.SEED_DEMO_USERS) and os.environ.get("ENV") != "production"
    return u
