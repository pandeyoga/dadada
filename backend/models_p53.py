...
class LegalAdvanceIn(BaseModel):
    ...
    # Surat keterangan / dasar pengecualian (WAJIB bila override dipakai).
    override_file_ids: List[str] = []
...
class KprStageIn(BaseModel):
    ...
    shortfall_due_date: Optional[str] = None  # jatuh tempo termin "Selisih Plafon KPR" (plafon < porsi bank)
