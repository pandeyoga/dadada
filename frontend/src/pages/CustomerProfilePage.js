      ...
      actions={(
        <>
          ...
          {can("customers", "delete") ? (
            <DeleteEntityButton entity="Customer" name={cust.name} testId="customer-delete"
              checkUrl={`/customers/${id}/delete-check`} deleteUrl={`/customers/${id}`}
      ...
      <TabPage header={header} tabs={[
        ...
        },
        {
          ...
          content: panels.units?.ok
            ? <CustomerUnitsTab customerId={id} />
        ...
        },
        {
          ...
          content: panels.complaints?.ok
            ? <CustomerComplaintsTab customer={cust} complaints={complaints} onChanged={load} />
