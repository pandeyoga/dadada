...
export default function SuppliersView({ currentUser, selectedEntity }) {
  ...
  function openEdit(s) {
    ...
    setForm({
      ...
      bank: { ...(s.bank || {}) },
      label_pattern: { ...DEFAULT_LABEL_PATTERN, ...(s.label_pattern || {}) },
    });
    setShowForm(true);
  }
    ...
    <div data-testid="suppliers-view">
      ...
      >
        <div className="space-y-3">
            ...
            <SupplierLabelPatternEditor
              value={form.label_pattern}
              onChange={(label_pattern) => setForm({ ...form, label_pattern })} />
            <Field label="Catatan">
