...
export const CRMC = {
  ...
  planAllin: "cust-payment-plan-allin",
  planAllinOpen: "cust-payment-plan-allin-open",
  planAllinRow: "cust-payment-plan-allin-row",
  planAllinInvoice: "cust-payment-plan-allin-invoice",
