        ...
        <DialogContent data-testid={BOOKING_FEE.payDialog} className="max-w-md">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <EvidenceUploader value={form.proof_file_ids || []} onChange={(v) => setForm({ ...form, proof_file_ids: v })} required
          ...
          <DialogFooter>
            ...
            <Button data-testid={BOOKING_FEE.paySubmit} disabled={busy || !Number(form.amount) || !(form.proof_file_ids || []).length} onClick={submit}>
