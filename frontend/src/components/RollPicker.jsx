...
export default function RollPicker({ productId, entityId, unitPrice = 0, baseUnit = "meter", onConfirm, warehouseId = "", confirmLabel = "" }) {
  ...
  }, [productId, entityId, warehouseId]);   // KN-D23 — ganti gudang WAJIB memuat ulang

  // KN-D23 — gudang berganti: buang pilihan roll gudang lama & kembali ke halaman awal.
  useEffect(() => { setSelected({}); setPage(0); }, [warehouseId]);
