...
import GlReconcileBanner from "@/components/finance/GlReconcileBanner";
    ...
    <div data-testid={FINANCE.dashboard} className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
        ...
        <KpiButton id="ap_outstanding" onOpen={open} label="Utang (AP) Outstanding" value={data.ap_outstanding} tone="amber"
          format="idr" hint={`= Utang Usaha 2-1100 \u00b7 ${c.ap_pending || 0} menunggu approval (${formatIDR(data.ap_pending_value || 0)})`} />
