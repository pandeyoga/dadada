...
import PricingApprovalSettings from "@/components/config/PricingApprovalSettings";
  ...
  return (
    <div data-testid={PRICING.panel} className="space-y-3">
      <p className="text-sm text-muted-foreground">
        ...
        mengetik nominal diskon. Nilai dihitung server dari harga (unit + add-on). Ketiga jenis aturan
        punya <b>mode persetujuan manajer</b> (ikut ambang organisasi / selalu / tidak pernah).
      </p>
      <PricingApprovalSettings />
