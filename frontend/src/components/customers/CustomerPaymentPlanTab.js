                ...
                <tr key={`${it.label || "termin"}-${i}`} data-testid={CRMC.planRow}
                  ...
                  <td className="px-3 py-2 font-medium">{it.label || `Termin ${i + 1}`}
                    ...
                    {it.kind === "kpr_shortfall" ? (
                      <span data-testid={`${CRMC.planRow}-shortfall`} className="ml-1.5 rounded-full bg-amber-100 px-1.5 text-[10px] font-normal text-amber-800">selisih plafon SP3K</span>
                    ) : null}
                    {it.kind === "kpr_shortfall" ? (
                      <span data-testid={`${CRMC.planRow}-shortfall`} className="ml-1.5 rounded-full bg-amber-100 px-1.5 text-[10px] font-normal text-amber-800">selisih plafon SP3K</span>
                    ) : null}
